...
import { createCollectorController } from "./collectors.js";
import { refreshIcons } from "./icons.js";
import { clearLogs, connectLogSocket, pollLogs, rerenderLogs } from "./logs.js";
import {
...
const {
  ...
  escapeHtml,
  parseBooleanValue,
  renderCollectMonitorList: (...args) => renderCollectMonitorList(...args),
  renderScheduleList: (...args) => renderScheduleList(...args),
  syncAccountVerifyIdentityHelp: (...args) => syncAccountVerifyIdentityHelp(...args),
  syncMonitorIdentityOverrides: (...args) => syncMonitorIdentityOverrides(...args),
  syncScheduleIdentityOverrides: (...args) => syncScheduleIdentityOverrides(...args),
  syncTaskIdentitySelector: (...args) => syncTaskIdentitySelector(...args),
  syncWorkflowAccountIdentityOverrides: (...args) => syncWorkflowAccountIdentityOverrides(...args),
  syncWorkflowDetailIdentitySelector: (...args) => syncWorkflowDetailIdentitySelector(...args),
});
