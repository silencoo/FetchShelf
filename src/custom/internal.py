...
PROJECT_NAME = (
    f"FetchShelf V{VERSION_MAJOR}.{VERSION_MINOR} "
    f"{'Beta' if VERSION_BETA else 'Stable'}"
)

REPOSITORY = "https://github.com/silencoo/FetchShelf"
LICENCE = "GNU General Public License v3.0"
DOCUMENTATION_URL = f"{REPOSITORY}#readme"
RELEASES = f"{REPOSITORY}/releases/latest"

DISCLAIMER_TEXT = (
    "关于 FetchShelf 的 免责声明：\n"
    "\n"
    ...
    "9. 本项目的作者不会提供 FetchShelf 项目的付费版本，也不会提供与 FetchShelf 项目相关的任何商业服务。\n"
